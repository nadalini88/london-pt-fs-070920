...
const clickTheButton = () => {
    const btn = document.getElementsByClassName('click').children[1];
 ...
 */
const hoverOver = () => {
    const aTag = document.querySelector('.mouseover').children[1];
...
const handleLeave = () => {
    const aTagLeave = document.querySelector('.mouseover').children[1];
    aTagLeave.addEventListener('mouseout', () => {
        console.log (`Bye`)
    })
};
handleLeave();
 ...
 */
 ...
 const focusOnMe = () => {
    const inputFocus = document.querySelector(' .input').children[1];
...
const clickElsewhere = () => {
    const inputClick = document.querySelector(' .input').children[1];
    inputClick.addEventListener('focusin', () => {
        console.log('Focus')
    });
    const browser = document.querySelectorAll('document');
 ...
 */
 ...
 const pressAKey = () => {
    ...
    inputClick.addEventListener ('onkeypress', () => {
        console.log('3 steps')  
    })
 }
/**
