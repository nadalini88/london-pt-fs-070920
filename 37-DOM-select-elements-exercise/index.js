...
function logAllParagraphs(item) {
 ...
 */
const greenText = document.getElementsByTagName("text", "green");
...
let thirdText = document.getElementById("textId-3");
 ...
 */
const fourthListElement = document.querySelector("li:nth-child(3)");
 ...
 */
const nextElements = document.querySelectorAll("div.li");